...
public class Quiz4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.option41).setOnClickListener(next);
        findViewById(R.id.option42).setOnClickListener(next);
        findViewById(R.id.option43).setOnClickListener(next);
        findViewById(R.id.option44).setOnClickListener(next);
